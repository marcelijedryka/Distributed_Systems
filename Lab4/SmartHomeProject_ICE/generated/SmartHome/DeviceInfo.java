                                   ...
                                   java.io.Serializable
{
    ...
    public DeviceInfo(String name, String location, String informations)
    {
        this.name = name;
    ...
    public boolean equals(java.lang.Object rhs)
    {
        ...
        if(r != null)
        {
            ...
            if(this.informations != r.informations)
            {
                if(this.informations == null || r.informations == null || !this.informations.equals(r.informations))
                {
                    return false;
                }
            }
    ...
    public int hashCode()
    {
        ...
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, informations);
        return h_;
    }
    ...
    public void ice_writeMembers(com.zeroc.Ice.OutputStream ostr)
    {
        ...
        ostr.writeString(this.informations);
    }
    ...
    public void ice_readMembers(com.zeroc.Ice.InputStream istr)
    {
        ...
        this.informations = istr.readString();
    }
    ...
    /** @hidden */
    public static final long serialVersionUID = 1914461705L;
}
